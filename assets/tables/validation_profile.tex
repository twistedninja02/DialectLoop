% Validation Dataset Profile Table for DialectLoop
...
\bottomrule
\end{tabular}
\caption{Stratified profile of the gold-standard validation dataset across core regional dialectal clusters.}
